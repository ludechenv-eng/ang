...
export const BlessingEnvelope: React.FC<BlessingEnvelopeProps> = ({ isOpen, name = "Angie" }) => {
  ...
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      // but we set showContent to false immediately to trigger the local transform exit if needed
      // Actually, it looks better if it stays visible while the whole thing fades out
